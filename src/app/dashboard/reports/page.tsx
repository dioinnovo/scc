  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-2">
            <TrendingUp className="w-8 h-8 text-scc-red" />
            <span className="text-xs font-medium px-2 py-1 bg-red-100 dark:bg-red-900/20 text-scc-red dark:text-red-400 rounded">Avg</span>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-scc-red/20 focus:border-scc-red"
            />
          </div>
                  ...
                  {report.status === 'pending_approval' ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-2 bg-scc-red text-white rounded-lg hover:bg-red-600 transition"
                      >
