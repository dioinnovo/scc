    ...
    <div className="space-y-4 sm:space-y-6 w-full">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/dashboard/activity" className="text-scc-red text-sm hover:underline">
            View All
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
            <div className="flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition">
              <AlertTriangle className="text-scc-red w-8 h-8 mb-2" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800">
            <Link
              href="/presentation"
              className="inline-flex items-center gap-2 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-scc-red bg-gray-50 dark:bg-gray-700 hover:bg-red-50 dark:hover:bg-gray-600 rounded-lg transition-all duration-200"
            >
