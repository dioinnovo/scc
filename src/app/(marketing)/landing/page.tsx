...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link href="/" className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-gray-900 dark:text-gray-100">SCC Intelligence</span>
              </Link>
            </div>
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-red-100 text-scc-red px-3 py-1 rounded-full text-sm font-medium mb-6">
                <Zap className="h-4 w-4" />
                AI-Powered Insurance Intelligence
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-6">
                Maximize Every
                <span className="text-scc-red"> Insurance Claim</span>
              </h1>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-100 to-blue-100 rounded-2xl p-8 shadow-2xl">
            ...
            {features.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg hover:shadow-xl transition">
                <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center mb-4">
                  <feature.icon className="h-6 w-6 text-scc-red" />
                </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="relative">
              <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg">
                <div className="w-12 h-12 bg-scc-red text-white rounded-full flex items-center justify-center font-bold text-xl mb-4">
                  1
                </div>
      ...
      <section id="testimonials" className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              See what our customers have to say about SCC Intelligence
            </p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
      ...
      {/* CTA Section */}
      <section className="py-20 lg:py-32 bg-scc-red">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/pricing" className="inline-flex items-center justify-center gap-2 bg-scc-red-dark text-white px-8 py-4 rounded-lg hover:bg-scc-red-dark transition font-semibold">
              View Pricing Plans
            </Link>
          </div>
          <p className="text-red-100 mt-6">No credit card required • 14-day free trial • Cancel anytime</p>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-scc-red rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold">S</span>
                </div>
                <span className="text-white font-bold">SCC Intelligence</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm">
            <p>© 2025 SCC Intelligence. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
