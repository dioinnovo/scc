              ...
              <div className="flex flex-wrap gap-2 justify-center max-w-sm">
                {[
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full text-sm text-gray-700 dark:text-gray-300 hover:border-scc-red hover:text-scc-red transition-all"
                  >
                    {suggestion}
                  </button>
                ))}
                        ...
                        <div className="mt-2 flex flex-wrap gap-2">
                          {message.suggestions.map((suggestion, idx) => (
                            <button
                              key={idx}
                              onClick={() => handleSend(suggestion)}
                              className="text-xs px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full hover:border-scc-red hover:text-scc-red transition"
                            >
                              {suggestion}
                            </button>
                          ))}
            ...
            >
              <div className="p-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-scc-red/30 focus:border-scc-red/50 mb-4"
                  autoFocus
                  onKeyDown={(e) => {
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-scc-red text-white hover:bg-red-600 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Continue
                  </button>
                </div>
